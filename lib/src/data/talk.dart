...
List<RecordEntity> talks = [
  ...
  new RecordEntity(
    ...
    subtitle: 'Přednáškový sraz ITnetwork',
    subtitleLink: 'https://www.itnetwork.cz/nezarazene/prednaskovy-sraz-itnetwork/detail/110',
    language: czech,
